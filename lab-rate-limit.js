 ...
 *
 * CÓMO EJECUTAR:
 *   1. Levantar Itm.Inventory.Api  → http://localhost:5273
...
const JWT_TOKEN = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJJdG1JZGVudGl0eVNlcnZlciIsImF1ZCI6Ikl0bVN0b3JlQXBpcyIsImVtYWlsIjoiYWRtaW5AaXRtLmVkdS5jbyIsInJvbGUiOiJBZG1pbmlzdHJhZG9yIn0.PaSdxe8NkHzbkrTA40janIgKn4gnVp63yWh_cenvUDw';
...
export default function () {
    ...
    const response = http.get(ENDPOINT, { headers, tags: { request_num: requestNumber } });
